async function getCurrencies() {
    ...
    const usdElement = data.Valute.USD.Value.toFixed(2) / data.Valute.BYN.Value.toFixed(2)
    const eurElement = data.Valute.EUR.Value.toFixed(2) / data.Valute.BYN.Value.toFixed(2)
